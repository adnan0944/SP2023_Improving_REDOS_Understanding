...
conditional
 : '(' '?' '(' number ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' '+' number ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' '-' number ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' '<' name '>' ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' '\'' name '\'' ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' 'R' number ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' 'R' ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' 'R' '&' name ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' 'D' 'E' 'F' 'I' 'N' 'E' ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' 'a' 's' 's' 'e' 'r' 't' ')' unionexp ('|' unionexp)? ')'
 | '(' '?' '(' name ')' unionexp ('|' unionexp)? ')'
 ;
...
//         (*THEN)         local failure, backtrack to next unionexp
